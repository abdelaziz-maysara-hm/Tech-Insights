...
| 5 | high | KEEP | Password Managers: Why You Need One and How to Start | guide |  |  | Build practical professional understanding |
| 6 | high | KEEP | Daily Active Directory Tasks with PowerShell: The Complete Guide | guide | infrastructure | microsoft | Build practical professional understanding |
| 7 | high | KEEP | Home Router Security: The Complete Step-by-Step Guide | guide | cybersecurity |  | Build practical professional understanding |
| 8 | high | KEEP | Using AI Assistants Safely for Technical Training: A Practical Guide | guide | cybersecurity |  | Build practical professional understanding |
| 9 | high | KEEP | Converting Windows Server from Evaluation to Standard Without Reinstalling | troubleshooting | infrastructure | microsoft | Resolve a specific engineering problem |
| 10 | high | KEEP | Setting Up a DNS Reverse Lookup Zone: The Complete Guide | troubleshooting | networking |  | Resolve a specific engineering problem |
| 11 | high | KEEP | Group Policy Fundamentals: The Complete Guide for Sysadmins | troubleshooting | cybersecurity |  | Resolve a specific engineering problem |
| 12 | high | KEEP | Zero Trust Without the Jargon: The Complete Principle and Practical Implementation Guide | guide | cybersecurity |  | Build practical professional understanding |
| 13 | high | KEEP | Certificate-Based Authentication with 802.1X: The Complete Guide | troubleshooting | networking |  | Resolve a specific engineering problem |
| 14 | high | KEEP | Setting Up DHCP Failover for Network Continuity: The Complete Guide | guide | networking |  | Build practical professional understanding |
| 15 | high | KEEP | Setting Up a Central Syslog Server: The Complete Guide to Where to Start | guide | infrastructure | microsoft | Build practical professional understanding |
| 16 | high | KEEP | Using Hyper-V Checkpoints Safely: The Complete Guide | troubleshooting | infrastructure | microsoft | Resolve a specific engineering problem |
| 17 | high | KEEP | Cutting Your Cloud Bill: The Complete Guide to Practical Steps Before the Surprise | guide | infrastructure |  | Build practical professional understanding |
| 18 | high | KEEP | USB Device Control Policy: The Complete Guide to Security Without Blocking Work | guide | cybersecurity |  | Build practical professional understanding |
| 19 | high | KEEP | Certificate Expiry Monitoring: The Complete Guide to Avoiding the Embarrassing Mistake | troubleshooting | infrastructure |  | Resolve a specific engineering problem |
| 20 | high | KEEP | Tabletop Exercises: Practice Before It Actually Happens | guide |  |  | Build practical professional understanding |
| 21 | high | KEEP | Network Access Control (NAC): Who's Even Allowed to Connect? | troubleshooting | cybersecurity |  | Resolve a specific engineering problem |
| 22 | high | KEEP | DNS Security: The Complete Guide from Malicious Site Filtering to DNSSEC | guide | cybersecurity |  | Build practical professional understanding |
| 23 | high | KEEP | Disk Encryption with BitLocker: Basics You Need to Know | guide | cybersecurity |  | Build practical professional understanding |
| 24 | high | KEEP | Advanced Windows Firewall Rules: More Than Just On/Off | troubleshooting | cybersecurity |  | Resolve a specific engineering problem |
| 25 | high | KEEP | XSS Vulnerabilities: The Complete Guide to How a Simple Site Can Steal User Data | guide | cybersecurity |  | Build practical professional understanding |
| 26 | medium | KEEP | Windows Server Core vs Desktop Experience: Which Should You Choose? | guide | infrastructure | microsoft | Build practical professional understanding |
| 27 | medium | KEEP | SPF, DKIM, and DMARC: The Complete Guide to Stopping Email Domain Spoofing | guide | cybersecurity |  | Build practical professional understanding |
