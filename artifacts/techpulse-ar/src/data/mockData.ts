...
export const mockArticles: Article[] = [
  {
    ...
    categoryId: 'reviews',
    author: {
      name: { ar: '???? ??? ?????', en: 'Technical Insights Team' },
...
export const mockComparisons: Comparison[] = [
  {
    ...
    specs: {
      display: {
        label: { ar: '??????', en: 'Display' },
        device1Value: { ar: '6.7 ???? Super Retina XDR OLED, 120Hz', en: '6.7" Super Retina XDR OLED, 120Hz' },
        device2Value: { ar: '6.8 ???? Dynamic AMOLED 2X, 120Hz', en: '6.8" Dynamic AMOLED 2X, 120Hz' },
        device1Score: 9,
        device2Score: 9.5,
        winner: 2
      },
      performance: {
        label: { ar: '??????', en: 'Performance' },
      ...
      camera: {
        label: { ar: '????????', en: 'Camera' },
        device1Value: { ar: '48MP ?????? + 12MP ??????? (5x) + 12MP ????? ?????', en: '48MP Main + 12MP Tele (5x) + 12MP Ultra-wide' },
        device2Value: { ar: '200MP ?????? + 50MP ??????? (5x) + 12MP ????? ?????', en: '200MP Main + 50MP Tele (5x) + 12MP Ultra-wide' },
        device1Score: 9.2,
        device2Score: 9.4,
        winner: 2
      },
      price: {
        label: { ar: '????? ???????', en: 'Starting Price' },
        device1Value: { ar: '1,199 ?????', en: '$1,199' },
        device2Value: { ar: '1,299 ?????', en: '$1,299' },
        device1Score: 8,
        device2Score: 7.5,
        winner: 1
      }
  ...
  },
  {
    ...
    specs: {
      ...
      battery: {
        label: { ar: '????????', en: 'Battery' },
        device1Value: { ar: '18 ????', en: '18 hours' },
        device2Value: { ar: '12 ????', en: '12 hours' },
        device1Score: 9.8,
        device2Score: 7.5,
        winner: 1
      },
      ...
      price: {
        label: { ar: '????? ???????', en: 'Starting Price' },
        device1Value: { ar: '1,099 ?????', en: '$1,099' },
        device2Value: { ar: '1,699 ?????', en: '$1,699' },
        device1Score: 9,
        device2Score: 6,
        winner: 1
      }
